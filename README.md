...
- `estimate_activity_fueling(activity_id, zone_carb_fractions)` — applies a caller-provided Z1..Z5 RER table; returns `durationSec`, `activeCalories`, `carbKcal`, `carbG`, `fatKcal`, `fatG`
