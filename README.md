...
- `get_activity_fueling(activity_id)` — active kcal, duration, HR, time-in-zones for macro estimation
- `estimate_activity_fueling(activity_id, zone_carb_fractions)` — applies a caller-provided Z1..Z5 RER table; returns carb/fat kcal+grams and carb g/hr
